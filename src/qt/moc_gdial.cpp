...
**
** Created: Wed Jul 9 11:46:04 2014
...
static const char qt_meta_stringdata_gDial[] = {
    "gDial\0"
};
...
const QMetaObjectExtraData gDial::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject gDial::staticMetaObject = {
    { &QDial::staticMetaObject, qt_meta_stringdata_gDial,
      qt_meta_data_gDial, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &gDial::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_gDial))
